...
enum EEventStatus
{
	...
	streamEventTooManyConsecutiveResends		= 6,	///<太多连续重传	///< \~english too many consecutive resends event
	streamEventTooManyLostPacket				= 7		///<太多丢包		///< \~english too many lost packet event
};
